...
const REGION_DATA = {
  ...
  '河北省': {
    ...
    '保定市': ['竞秀区','莲池区','满城区','清苑区','徐水区','涞水县','阜平县','定兴县','唐县','高阳县','容城县','涞源县','望都县','易县','曲阳县','蠡县','顺平县','博野县','涿州市','定州市','安国市','高碑店市'],
  ...
  '浙江省': {
    '杭州市': ['上城区','拱墅区','西湖区','滨江区','萧山区','余杭区','富阳区','临安区','桐庐县','淳安县','建德市'],
  ...
  '湖北省': {
    ...
    '仙桃市': ['仙桃市'],'潜江市': ['潜江市'],'天门市': ['天门市'],'神农架林区': ['神农架林区']
  },
  '湖南省': {
  ...
  '广东省': {
    ...
    '肇庆市': ['端州区','鼎湖区','广宁县','怀集县','封开县','德庆县','高要区','四会市'],
  ...
  '海南省': {
    ...
    '三沙市': ['西沙群岛','南沙群岛','中沙群岛'],
    '儋州市': ['儋州市'],
    '五指山市': ['五指山市'],'琼海市': ['琼海市'],'文昌市': ['文昌市'],'万宁市': ['万宁市'],'东方市': ['东方市'],
    '定安县': ['定安县'],'屯昌县': ['屯昌县'],'澄迈县': ['澄迈县'],'临高县': ['临高县'],
    '白沙黎族自治县': ['白沙黎族自治县'],'昌江黎族自治县': ['昌江黎族自治县'],'乐东黎族自治县': ['乐东黎族自治县'],'陵水黎族自治县': ['陵水黎族自治县'],'保亭黎族苗族自治县': ['保亭黎族苗族自治县'],'琼中黎族苗族自治县': ['琼中黎族苗族自治县']
  },
  ...
  '贵州省': {
    ...
    '遵义市': ['红花岗区','汇川区','播州区','桐梓县','绥阳县','正安县','道真仡佬族苗族自治县','务川仫佬族苗族自治县','凤冈县','湄潭县','余庆县','习水县','赤水市','仁怀市'],
  ...
  '青海省': {
    '西宁市': ['城中区','城东区','城西区','城北区','湟中区','湟源县','大通回族土族自治县'],
  ...
  '台湾省': {
    ...
    '高雄市': ['盐埕区','鼓山区','左营区','楠梓区','三民区','新兴区','前金区','苓雅区','前镇区','旗津区','小港区'],
    ...
    '新北市': ['板桥区','新庄区','中和区','永和区','土城区','树林区','三峡区','莺歌区','三重区','芦洲区','五股区','泰山区','林口区','八里区','淡水区','三芝区','石门区','金山区','万里区','汐止区','平溪区','瑞芳区','贡寮区','双溪区','深坑区','石碇区','坪林区','乌来区'],
    '桃园市': ['桃园区','中坜区','平镇区','八德区','杨梅区','芦竹区','大溪区','龙潭区','龟山区','大园区','观音区','新屋区','复兴区'],
    '基隆市': ['仁爱区','信义区','中正区','中山区','安乐区','暖暖区','七堵区'],
    '新竹市': ['东区','北区','香山区'],
    '嘉义市': ['东区','西区'],
    '新竹县': ['竹北市','竹东镇','新埔镇','关西镇','峨眉乡','宝山乡','北埔乡','横山乡','芎林乡','湖口乡','新丰乡','尖石乡','五峰乡'],
    '苗栗县': ['苗栗市','头份市','竹南镇','后龙镇','通霄镇','苑里镇','卓兰镇','大湖乡','公馆乡','铜锣乡','南庄乡','头屋乡','三义乡','西湖乡','造桥乡','三湾乡','狮潭乡','泰安乡'],
    '彰化县': ['彰化市','员林市','鹿港镇','和美镇','北斗镇','溪湖镇','田中镇','二林镇','线西乡','伸港乡','福兴乡','秀水乡','花坛乡','芬园乡','大村乡','埔盐乡','埔心乡','永靖乡','社头乡','田尾乡','埤头乡','溪州乡','竹塘乡','二水乡','大城乡','芳苑乡'],
    '南投县': ['南投市','埔里镇','草屯镇','竹山镇','集集镇','名间乡','鹿谷乡','中寮乡','鱼池乡','国姓乡','水里乡','信义乡','仁爱乡'],
    '云林县': ['斗六市','虎尾镇','西螺镇','土库镇','北港镇','古坑乡','大埤乡','莿桐乡','林内乡','二仑乡','仑背乡','麦寮乡','东势乡','褒忠乡','台西乡','元长乡','四湖乡','口湖乡','水林乡'],
...
function extractCounty(locationStr) {
  ...
  for (const province of Object.keys(REGION_DATA)) {
    for (const city of Object.keys(REGION_DATA[province])) {
      for (const county of REGION_DATA[province][city]) {
        if (locationStr.includes(county)) return county;
      }
    }
  }
  return null;
